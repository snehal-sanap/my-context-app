  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p
          className={
            theme === "light" ? "mt-2 text-slate-500" : "mt-2 text-slate-400"
          }
        >
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <h4 className="mb-3 text-sm font-medium text-slate-500">👤 User</h4>
        ...
        >
          <h4 className="mb-3 text-sm font-medium text-slate-500">✉️ Email</h4>
        ...
        >
          <h4 className="mb-3 text-sm font-medium text-slate-500">⚡ Role</h4>
        ...
        >
          <h4 className="mb-3 text-sm font-medium text-slate-500">🎨 Theme</h4>
